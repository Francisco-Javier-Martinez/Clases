...
<body id="pantalla-inicio">
    ...
    <main>
        <a href="index.php?controlador=pdf&metodo=convertirPdfSoloMinijuegos" target="_blank" class="btn-pdf"> Generar PDF de minijuegos solo </a>
        <a href="index.php?controlador=pdf&metodo=convertirPdf" target="_blank" class="btn-pdf"> Generar PDF de todo</a>
