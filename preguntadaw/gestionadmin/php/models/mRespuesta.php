...
//PDO
    ...
    class Mrespuesta extends Conexion{
        ...
        //metodo para insertar respuestas sin preparadas
        public function meterRespuestasNoSegura($idTema, $nPregunta, $letra, $respuesta, $esCorrecta){
            try{
                ...
                $sql = "INSERT INTO respuestas (idTema, nPregunta, nLetra,
                            texto, es_correcta) 
                            VALUES ($idTema, $nPregunta, '$letra', '$respuesta', $esCorrecta)"; 
                echo $sql;
                //Ejecutar consulta
